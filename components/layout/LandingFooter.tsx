    ...
    >
      ...
      >
        <SimpleGrid cols={2} breakpoints={[{ maxWidth: "xs", cols: 1 }]}>
          ...
          <Group>
            <Text c="dimmed" fz="xs">
              All trademarks on SurvivorPool.win are property of their
              respective owners. SurvivorPool.win is not affiliated with the
              National Football League (NFL) or any of its members.
            </Text>
            <Text c="dimmed" fz="xs">
