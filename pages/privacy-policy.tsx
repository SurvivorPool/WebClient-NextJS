...
const PrivacyPolicy = () => (
  <Container>
    ...
    <p>
      SurvivorPool.win operates the https://survivorpool.win website, which
      provides the SERVICE.
    </p>
    <p>
      This page is used to inform website visitors regarding our policies with
      the collection, use, and disclosure of Personal Information if anyone
      decided to use our Service, the SurvivorPool website.
    </p>
    <p>
    ...
    <p>
      ...
      Terms and Conditions, which is accessible at https://survivorpool.win,
    ...
    <h2>Data Deletion</h2>
    <p>
      Users of our service may request data deletion at any time by contacting
      us at <a href="mailto:admin@survivorpool.win">admin@survivorpool.win</a>.
      Requests will be processed in 1-2 business days.
    </p>
