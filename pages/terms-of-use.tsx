    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to SurvivorPool.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to SurvivorPool, accessible from{" "}
          <a
            href="https://www.survivorpool.win"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://www.survivorpool.win
          </a>
        </p>
      </li>
      <li>
